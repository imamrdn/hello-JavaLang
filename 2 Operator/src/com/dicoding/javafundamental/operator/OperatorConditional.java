...
public class OperatorConditional {
    public static void main(String[] args){
        ...
        System.out.println("Hasil operatot AND pada syarat value != 3 dan anotherValue == 5 adalah " + anotherResult);
        System.out.println();
        ...
        System.out.println("Hasil operator OR pada syarat value == 3 atau anotherValue == 5 adalah " + result);
        System.out.println("Hasil operator OR pada syarat value != 3 atau anotherValue == 5 adalah " + anotherResult);
    }
}
